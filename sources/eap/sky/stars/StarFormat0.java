...
/*********************************************************************
* This is an old format with the magnitudes stored as the full class
* name of the band and a double.
*********************************************************************/
public class StarFormat0 extends StarFormat {
...
public void write(Star star, DataOutput out) throws IOException {
    ...
    for(Iterator it = photometry.getMagnitudes().iterator(); it.hasNext(); ) {
        ...
        mag.getBand().write(out);
        out.writeDouble(mag.getValue());
